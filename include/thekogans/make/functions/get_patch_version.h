...
#if !defined (__thekogans_make_functions_get_patch_version_h)
#define __thekogans_make_functions_get_patch_version_h
...
#endif // !defined (__thekogans_make_functions_get_patch_version_h)
