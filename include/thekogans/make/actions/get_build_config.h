...
#if !defined (__thekogans_make_actions_get_build_config_h)
#define __thekogans_make_actions_get_build_config_h
...
#endif // !defined (__thekogans_make_actions_get_build_config_h)
