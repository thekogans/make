...
#if !defined (__thekogans_make_actions_get_toolchain_source_project_versions_h)
#define __thekogans_make_actions_get_toolchain_source_project_versions_h
...
#endif // !defined (__thekogans_make_actions_get_toolchain_source_project_versions_h)
