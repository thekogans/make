...
#if !defined (__thekogans_make_actions_cleanup_source_project_h)
#define __thekogans_make_actions_cleanup_source_project_h
...
#endif // !defined (__thekogans_make_actions_cleanup_source_project_h)
