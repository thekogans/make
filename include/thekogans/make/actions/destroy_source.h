...
#if !defined (__thekogans_make_actions_destroy_source_h)
#define __thekogans_make_actions_destroy_source_h
...
#endif // !defined (__thekogans_make_actions_destroy_source_h)
