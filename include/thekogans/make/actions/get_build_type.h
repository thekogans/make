...
#if !defined (__thekogans_make_actions_get_build_type_h)
#define __thekogans_make_actions_get_build_type_h
...
#endif // !defined (__thekogans_make_actions_get_build_type_h)
