...
#if !defined (__thekogans_make_actions_get_naming_convention_h)
#define __thekogans_make_actions_get_naming_convention_h
...
#endif // !defined (__thekogans_make_actions_get_naming_convention_h)
