...
#if !defined (__thekogans_make_actions_install_program_h)
#define __thekogans_make_actions_install_program_h
...
#endif // !defined (__thekogans_make_actions_install_program_h)
