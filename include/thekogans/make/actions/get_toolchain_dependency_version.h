...
#if !defined (__thekogans_make_actions_get_toolchain_dependency_version_h)
#define __thekogans_make_actions_get_toolchain_dependency_version_h
...
#endif // !defined (__thekogans_make_actions_get_toolchain_dependency_version_h)
