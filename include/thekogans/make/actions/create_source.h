...
#if !defined (__thekogans_make_actions_create_source_h)
#define __thekogans_make_actions_create_source_h
...
#endif // !defined (__thekogans_make_actions_create_source_h)
