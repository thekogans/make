...
#if !defined (__thekogans_make_actions_list_toolchain_sources_h)
#define __thekogans_make_actions_list_toolchain_sources_h
...
#endif // !defined (__thekogans_make_actions_list_toolchain_sources_h)
