...
#if !defined (__thekogans_make_actions_get_toolchain_source_url_h)
#define __thekogans_make_actions_get_toolchain_source_url_h
...
#endif // !defined (__thekogans_make_actions_get_toolchain_source_url_h)
