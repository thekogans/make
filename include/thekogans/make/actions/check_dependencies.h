...
#if !defined (__thekogans_make_actions_check_dependencies_h)
#define __thekogans_make_actions_check_dependencies_h
...
#endif // !defined (__thekogans_make_actions_check_dependencies_h)
