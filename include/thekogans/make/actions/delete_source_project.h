...
#if !defined (__thekogans_make_actions_delete_source_project_h)
#define __thekogans_make_actions_delete_source_project_h
...
#endif // !defined (__thekogans_make_actions_delete_source_project_h)
