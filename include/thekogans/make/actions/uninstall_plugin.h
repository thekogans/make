...
#if !defined (__thekogans_make_actions_uninstall_plugin_h)
#define __thekogans_make_actions_uninstall_plugin_h
...
#endif // !defined (__thekogans_make_actions_uninstall_plugin_h)
