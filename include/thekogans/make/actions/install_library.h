...
#if !defined (__thekogans_make_actions_install_library_h)
#define __thekogans_make_actions_install_library_h
...
#endif // !defined (__thekogans_make_actions_install_library_h)
