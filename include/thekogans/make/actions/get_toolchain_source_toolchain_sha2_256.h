...
#if !defined (__thekogans_make_actions_get_toolchain_source_toolchain_sha2_256_h)
#define __thekogans_make_actions_get_toolchain_source_toolchain_sha2_256_h
...
#endif // !defined (__thekogans_make_actions_get_toolchain_source_toolchain_sha2_256_h)
