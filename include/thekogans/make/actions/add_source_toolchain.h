...
#if !defined (__thekogans_make_actions_add_source_toolchain_h)
#define __thekogans_make_actions_add_source_toolchain_h
...
#endif // !defined (__thekogans_make_actions_add_source_toolchain_h)
