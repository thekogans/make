...
#if !defined (__thekogans_make_actions_add_toolchain_source_h)
#define __thekogans_make_actions_add_toolchain_source_h
...
#endif // !defined (__thekogans_make_actions_add_toolchain_source_h)
