    ...
    namespace make {
        ...
        namespace {
            struct get_toolchain_source_toolchain_versions : public Action {
                THEKOGANS_MAKE_CORE_DECLARE_ACTION (get_toolchain_source_toolchain_versions)
            ...
            THEKOGANS_MAKE_CORE_IMPLEMENT_ACTION (get_toolchain_source_toolchain_versions)
        }
