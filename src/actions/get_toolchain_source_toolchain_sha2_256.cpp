    ...
    namespace make {
        ...
        namespace {
            struct get_toolchain_source_toolchain_sha2_256 : public Action {
                THEKOGANS_MAKE_CORE_DECLARE_ACTION (get_toolchain_source_toolchain_sha2_256)
            ...
            THEKOGANS_MAKE_CORE_IMPLEMENT_ACTION (get_toolchain_source_toolchain_sha2_256)
        }
